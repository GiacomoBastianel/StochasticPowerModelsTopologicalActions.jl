...
opf_30 = _PM.solve_opf(test_case_opf, LPACCPowerModel, gurobi)
#########################################################################################
...
findmin(obj_bs)
result_bs_30["69"]["objective"]/opf_30["objective"]
...
result_bs = _SPMTA.run_stochastic_acdcsw_AC_ZIL(test_case_bs_mn,LPACCPowerModel,gurobi; setting = s)
