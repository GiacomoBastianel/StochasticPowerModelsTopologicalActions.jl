function hourly_feasibility_check_bs_scenarios(grid,results_bs,switches_couples,extremes_ZILs,hours,zones,load_time_series,res_time_series,optimizer,formulation,opf_grid,s)
    results = Dict()
