...
#add_VOLL_generators(test_case_118)

test_case_118_opf = deepcopy(original_grid_118)
opf_118 = _PM.solve_opf(original_grid_118, LPACCPowerModel, gurobi_opf)
opf_118_ac = _PM.solve_opf(original_grid_118, ACPPowerModel, ipopt)

#opf_gen = []
#for (g_id,g) in original_grid_118["gen"]
#    println("$(g_id), $(opf_118["solution"]["gen"]["$g_id"]["pg"]),$(g["gen_bus"])")
#    push!(opf_gen,[g_id,opf_118["solution"]["gen"]["$g_id"]["pg"],g["gen_bus"]])
#end
...
for sw_id in 1:length(extremes_ZILs_ac)
    test_case_118_bs["switch"]["$sw_id"]["cost"] = 10.0
end

result_bs_118 = _PMTP.run_acdcsw_AC_big_M(test_case_118_bs,LPACCPowerModel,gurobi_opf; setting = s)

#print_switch_results(test_case_118_bs,test_case_118_opf,result_bs_118)
#
#
#feasibility_check = deepcopy(test_case_118_bs)
#feasibility_check_input = deepcopy(test_case_118_bs)
#_PMTP.prepare_AC_feasibility_check(result_bs_118,feasibility_check_input,feasibility_check,switches_couples_ac,extremes_ZILs_ac,original_grid_118)
#result_feasibility_check_lpac = _PMACDC.run_acdcopf(feasibility_check,LPACCPowerModel,gurobi; setting = s)
...
differences = [] 
for i in 2:length(P50_11h)
    push!(differences, abs(P50_11h[i] - P50_11h[i-1]))
end
findmax(differences)
...
forecasted_wind_118 = []
for i in hours_try
    push!(forecasted_wind_118,P50_11h[i])
end

#measured_wind_118   = [Wind_data["$i"]["measured_pu"]   for i in 1:length(hours)]
#forecasted_wind_118 = [Wind_data["$i"]["P50_11hforecast_pu"] for i in 1:length(hours)]
#load_pu = [Load_data["$i"]["total_load_pu"] for i in 1:length(hours)]

#forecasted_wind_118[1] = 0.95
#forecasted_wind_118[2] = 0.0
#forecasted_wind_118[4] = 0.0
#forecasted_wind_118[6] = 0.95
#forecasted_wind_118[7] = 0.0
...
for i in 1:(n_hours*one_scenario)
    #test_case_118_opf_mn_forecasted["nw"]["$i"]["gen"]["37"]["pmax"] = deepcopy(test_case_118_opf_replicate["nw"]["$i"]["gen"]["37"]["pmax"]*forecasted_wind_118[i])
    test_case_118_opf_mn_forecasted["nw"]["$i"]["gen"]["30"]["pmax"] = deepcopy(test_case_118_opf_replicate["nw"]["$i"]["gen"]["30"]["pmax"]*forecasted_wind_118[i])
end
...
#test_case_118_bs_replicate_mn_measured = deepcopy(test_case_118_bs_replicate)
test_case_118_bs_replicate_mn_forecasted = deepcopy(test_case_118_bs_replicate)
for i in 1:(n_hours*one_scenario)
    #test_case_118_bs_replicate_mn_forecasted["nw"]["$i"]["gen"]["37"]["pmax"] = deepcopy(test_case_118_bs_replicate["nw"]["$i"]["gen"]["37"]["pmax"]*forecasted_wind_118[i])
    test_case_118_bs_replicate_mn_forecasted["nw"]["$i"]["gen"]["30"]["pmax"] = deepcopy(test_case_118_bs_replicate["nw"]["$i"]["gen"]["30"]["pmax"]*forecasted_wind_118[i])
end
...
function run_feasibility_checks_per_hour(grid, result_bs, model, optimizer,switches_couples_ac,extremes_ZILs_ac,test_case_118_opf,result_opf)
    ...
    for hour in 1:length(grid["nw"])
        ...
        prepare_AC_feasibility_check(result_bs["$hour"],feasibility_check_input,feasibility_check,switches_couples_ac,extremes_ZILs_ac,test_case_118_opf)
...
result_forecasted_feasibility_checks_118_ac = run_feasibility_checks_per_hour(test_case_118_bs_replicate_mn_forecasted,result_bs_hourly_forecasted_118,ACPPowerModel,ipopt,switches_couples_ac,extremes_ZILs_ac,original_grid_118,result_forecasted_118)
result_forecasted_feasibility_checks_118_lpac = run_feasibility_checks_per_hour(test_case_118_bs_replicate_mn_forecasted,result_bs_hourly_forecasted_118,LPACCPowerModel,gurobi,switches_couples_ac,extremes_ZILs_ac,original_grid_118,result_forecasted_118)
...
sum(obj_fc_forecasted_118_ac)

[result_bs_hourly_forecasted_118["$i"]["solution"]["switch"]["1"]["status"] for i in 1:n_hours]
[result_bs_hourly_forecasted_118["$i"]["solution"]["gen"]["30"]["pg"] for i in 1:n_hours]
...
print_switch_results_hourly(test_case_118_bs_replicate_mn_forecasted,test_case_118_opf,result_bs_hourly_forecasted,4)
...
[result_bs_hourly_forecasted_one_topology_118["solution"]["nw"]["4"]["switch"]["$sw_id"]["status"] for (sw_id,sw) in test_case_118_bs["switch"]]
[result_bs_hourly_forecasted["4"]["solution"]["switch"]["$sw_id"]["status"] for (sw_id,sw) in test_case_118_bs["switch"]]
...
#test_case_118_bs_2_118 = deepcopy(test_case_118_bs_replicate_mn_forecasted_sp)
#test_case_118_bs_2_118["total_switching_actions"] = 2
#test_case_118_bs_2_result_118 = _SPMTA.run_stochastic_acdcsw_AC_ZIL_limit_switching_actions_sp(test_case_118_bs_2_118,LPACCPowerModel,gurobi_opf)
#
...
test_case_118_bs_3_result_118 = _SPMTA.run_stochastic_acdcsw_AC_ZIL_limit_switching_actions_sp(test_case_118_bs_3_118,LPACCPowerModel,gurobi_opf)
...
test_case_118_bs_4_118 = deepcopy(test_case_118_bs_replicate_mn_forecasted_sp)
test_case_118_bs_4_118["total_switching_actions"] = 4
test_case_118_bs_4_result_118 = _SPMTA.run_stochastic_acdcsw_AC_ZIL_limit_switching_actions_sp(test_case_118_bs_4_118,LPACCPowerModel,gurobi_opf)

[test_case_118_bs_4_result_118["solution"]["nw"]["$i"]["switch"]["1"]["status"] for i in 1:n_hours]

test_case_118_bs_5_118 = deepcopy(test_case_118_bs_replicate_mn_forecasted_sp)
test_case_118_bs_5_118["total_switching_actions"] = 5
test_case_118_bs_5_result_118 = _SPMTA.run_stochastic_acdcsw_AC_ZIL_limit_switching_actions_sp(test_case_118_bs_5_118,LPACCPowerModel,gurobi_opf)

[test_case_118_bs_5_result_118["solution"]["nw"]["$i"]["switch"]["1"]["status"] for i in 1:8]


test_case_118_bs_6_118 = deepcopy(test_case_118_bs_replicate_mn_forecasted_sp)
test_case_118_bs_6_118["total_switching_actions"] = 6
test_case_118_bs_6_result_118 = _SPMTA.run_stochastic_acdcsw_AC_ZIL_limit_switching_actions_sp(test_case_118_bs_6_118,LPACCPowerModel,gurobi_opf)

[test_case_118_bs_6_result_118["solution"]["nw"]["$i"]["switch"]["1"]["status"] for i in 1:n_hours]
...
[result_fc_hourly_forecasted_one_topology_118["$i"]["termination_status"] for i in 1:n_hours]

[result_forecasted_feasibility_checks["$i"]["solution"]["gen"]["2"]["pg"] for i in 1:n_hours]
[result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["gen"]["2"]["pg"] for i in 1:n_hours]


test_case_118_opf["branch"]["1"]
test_case_118_opf["branch"]["2"]
test_case_118_opf["branch"]["3"]
test_case_118_opf["branch"]["4"]
test_case_118_opf["branch"]["5"]
test_case_118_opf["branch"]["6"]
...
result_fc_hourly_forecasted_one_topology_118["objective"]/result_bs_hourly_forecasted_one_topology_118["objective"]
(1-sum(result_bs_hourly_forecasted_118["$i"]["objective"] for i in 1:n_hours)/result_bs_hourly_forecasted_one_topology_118["objective"])*100
...
full_forecasted_sw_1 = [result_bs_hourly_forecasted_118["$i"]["solution"]["switch"]["1"]["status"] for i in 1:n_hours]
one_topology_sw_1 = [result_bs_hourly_forecasted_one_topology_118["solution"]["nw"]["$i"]["switch"]["1"]["status"] for i in 1:n_hours]
max_switch_1_sw_1 = [test_case_118_bs_1_result["solution"]["nw"]["$i"]["switch"]["1"]["status"] for i in 1:n_hours]
max_switch_3_sw_1 = [test_case_118_bs_3_result["solution"]["nw"]["$i"]["switch"]["1"]["status"] for i in 1:n_hours]
...
obj_full_forecasted = [result_bs_hourly_forecasted_118["$i"]["objective"] for i in 1:n_hours]

fc_forecasted    = [result_forecasted_feasibility_checks["$i"]["objective"] for i in 1:n_hours]
fc_one_topology  = [result_fc_hourly_forecasted_one_topology_118["$i"]["objective"] for i in 1:n_hours]
...
#=
function compute_hourly_objective(results,test_case_118,n_hours)
    obj = []
    for nw in 1:n_hours
        obj_i = 0
        for (g_id,g) in test_case_118["gen"]
            if g["pmax"] != 0.0
...
=#
#obj_one_topology = compute_hourly_objective(result_bs_hourly_forecasted_one_topology_118,test_case_118_bs,n_hours)
#obj_max_switch_1 = compute_hourly_objective(test_case_118_bs_1_result,test_case_118_bs,n_hours)
#obj_max_switch_3 = compute_hourly_objective(test_case_118_bs_3_result,test_case_118_bs,n_hours)

plot(obj_forecasted_118,ylims = (5*10^3,17*10^3),yticks = 0:5000:15000,ylabel = "Generation costs [\$/h]",xlabel = "Hour",label = "OPF",xlims=(0.9,9),xticks = 1:1:8, legend = :topright, grid = :none)
...
br_1_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["1"]["pf"] for i in 1:n_hours]

br_6_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["6"]["pf"] for i in 1:n_hours]
br_6_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["6"]["pf"] for i in 1:n_hours]

br_7_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["7"]["pf"] for i in 1:n_hours]
br_7_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["7"]["pf"] for i in 1:n_hours]

br_9_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["9"]["pf"] for i in 1:n_hours]
br_9_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["9"]["pf"] for i in 1:n_hours]

br_10_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["10"]["pf"] for i in 1:n_hours]
br_10_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["10"]["pf"] for i in 1:n_hours]

br_11_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["11"]["pf"] for i in 1:n_hours]
br_11_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["11"]["pf"] for i in 1:n_hours]

br_12_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["12"]["pf"] for i in 1:n_hours]
br_12_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["12"]["pf"] for i in 1:n_hours]

br_41_fc_hourly  = [result_forecasted_feasibility_checks["$i"]["solution"]["branch"]["41"]["pf"] for i in 1:n_hours]
br_41_fc_one_top = [result_fc_hourly_forecasted_one_topology_118["$i"]["solution"]["branch"]["41"]["pf"] for i in 1:n_hours]
